...
<title>Form Pendidikan PTK</title>
...
<?php if($tipe=="edit"){ ?>
	...
	<form action="<?=base_url()?>index.php/ptk/actionPendptk" method="post">
...
<!-- form input --->
	...
	<form action="<?=base_url()?>index.php/pendptk/savePendptk" method="post">
	...
	<tr class="tr_head" align="center">
	  <td colspan="2">Form Input Pendidikan PTK</td>
	</tr>
	<tr class="tr_data">
	  <td>&nbsp;Nama PTK</td>
    ...
    <tr class="tr_data">
      <td>&nbsp;Jenjang</td>
      <td><input type="text" name="jenjang" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Prodi</td>
      <td><input type="text" name="prodi" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Jurusan</td>
      <td><input type="text" name="jurusan" size="50" class="text_box"></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Nama PT</td>
      <td><input type="text" name="nama_pt" size="50" class="text_box" /></td>
    </tr>
    <tr class="tr_data">
      <td>&nbsp;Kota PT</td>
      <td><input type="text" name="kota_pt" size="50" class="text_box" /></td></tr>
      
    <tr align="center" class="tr_button" ><td colspan="2"><input type="button" value="Batalkan"  class="button" onclick="location.href='<?=base_url()?>index.php/pendptk/pendptkData';"/>&nbsp;<input type="submit" value="Simpan" class="button" /></td></tr>
	</table>
</form>
