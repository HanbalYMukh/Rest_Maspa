...
<!-- form input --->
	...
	<form action="<?=base_url()?>index.php/kurikulum/saveData" method="post">
	...
	<tr class="tr_head" align="center">
	  <td colspan="2">Form Input Kurikulum</td>
	</tr>
	<tr class="tr_data">
	  <td>&nbsp;Nama Pelajaran</td>
	  <td><input type="text" name="nama_pelajaran" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Kelompok</td>
      <td><input type="text" name="kelompok" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Jumlah Jam</td>
      <td><input type="text" name="jml_jam" size="50" class="text_box" /></td></tr>
    
    <tr align="center" class="tr_button" ><td colspan="2"><input type="button" value="Batalkan"  class="button" onclick="location.href='<?=base_url()?>index.php/kurikulum/getData';"/>&nbsp;<input type="submit" value="Simpan" class="button" /></td></tr>
	</table>
</form>
