...
<?php if($tipe=="edit"){ ?>
	...
	<form action="<?=base_url()?>index.php/ptk/actionPtk" method="post">
...
<!-- form input --->
	...
	<form action="<?=base_url()?>index.php/ptk/savePtk" method="post">
	...
	<tr class="tr_head" align="center">
	  <td colspan="2">Form Input Profil PTK</td>
	</tr>
	<tr class="tr_data">
	  <td>&nbsp;N U P T K</td>
    ...
    <tr class="tr_data">
      <td>&nbsp;Nama PTK</td>
      <td><input type="text" name="nama_ptk" size="50" class="text_box" /></td></tr>
    ...
    <tr class="tr_data"><td>&nbsp;Tempat Lahir</td><td><input type="text" name="tmplahir_ptk" size="50" class="text_box" /></td></tr>
    <tr class="tr_data"><td>&nbsp;Tanggal Lahir</td><td>
    <input type="text" name="demo3" id="demo3" maxlength="25" size="25" class="text_box"><a href="javascript:NewCssCal('demo3','yyyymmdd')">
	...
	<tr class="tr_data"><td>&nbsp;Alamat</td><td>
	  <textarea name="alamat_ptk" class="textarea" cols="45"></textarea></td></tr>
    <tr class="tr_data"><td>&nbsp;Kota</td><td><input type="text" name="kota_ptk" size="50" class="text_box" /></td></tr>
    <tr class="tr_data"><td>&nbsp;Kodepos</td><td><input type="text" name="kodepos_ptk" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Telp.</td>
      <td><input type="text" name="telp_ptk" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Gol. PTK</td>
      <td><input type="text" name="gol_ptk" size="50" class="text_box" /></td></tr>
    <tr class="tr_data">
      <td>&nbsp;Pendidikan Terakhir</td>
      <td><!--input type="text" name="pendidikan_kepsek" size="50" class="text_box" /--><select name="pendidikan_ptk" class="select_box">
    	<option value="">&nbsp;-- Pilih -- </option>
     ...
     <tr class="tr_data">
      <td>&nbsp;Status</td>
      <td><!--input type="text" name="status_ptk" size="50" class="text_box" /-->
