...
<div> Input Data Nilai tugas </div>
<br>

<table>
<form method="POST" action="<?=base_url()?>index.php/data_nilai_tugas/addData/<?= $kelas;?>">
<?php 
	$i=1;
	foreach($man as $d)	:?>
	<tr>
	...
	<select name='jenis'>
		<option value=''>Pilih</option>
		<option value='1'>Tugas Satu</option>
		<option value='2'>Tugas Dua</option>
		<option value='3'>Tugas Tiga</option>
		<option value='4'>Tugas Empat</option>
		<option value='5'>Tugas Lima</option>
	</select>
