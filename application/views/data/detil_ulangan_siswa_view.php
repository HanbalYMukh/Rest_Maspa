...
function tanya(id){
		if(confirm('Hapus Data Terpilih?')){
			load_no_loading("<?=base_url()?>index.php/data_nilai_ulangan/hapus/"+id,id)
			return true;
		}else{
			return false;
		}
...
<script>
function ask(jenis,id){
		if(confirm('Hapus Data Terpilih?')){
			load_onfly_loading("<?=base_url()?>index.php/data_nilai_ulangan/hapusOnfly/"+jenis+"/"+id,id,jenis)
			return true;
		}else{
			return false;
		}
...
<div id="dialog-form">
	...
	<form id="Form" method="GET" action="<?=base_url()?>index.php/data_nilai_ulangan/viewDetail" charset='utf-8'>
	<fieldset>
...
<div id="Dialog" title="Edit Nilai ulangan">
 <form id="formEdit" method="POST" action="<?=base_url()?>index.php/data_nilai_ulangan/edit" charset="utf-8">
 Ubah Nilai Berikut 
	<input  id="nilai" type="text" name="nilai" value="" size="3" maxlength="3"></input>
	<input  id="id" type="hidden" name="id" value=""></input>
	<input  id="jenis" type="hidden" name="jenis" value=""></input>
