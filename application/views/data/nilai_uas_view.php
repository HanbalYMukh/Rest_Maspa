...
<div id="dialog-form">
	...
	<form id="Form" method="GET" action="<?=base_url()?>index.php/data_nilai_uas/viewSpesifik" charset='utf-8'>
	<fieldset>
...
<?php echo anchor('data_nilai_uas/addData/'.$kelas, '<button class="add">Tambah data</button>
'); ?>
<div id="header_data" align="center">
		...
		<tr>
		  <td align="center" colspan="2"> <span class="seratus">Rekor 100 Nilai UAS Terbaik kelas <? echo "".$nama_kelas->no_ruang; ?></span><span class="datakelas"> kelas <? echo "".$nama_kelas->no_ruang; ?> </span> </td>
		</tr>
		</table>
