...
function tanya(id){
		if(confirm('Hapus Data Terpilih?')){
			load_no_loading("<?=base_url()?>index.php/data_nilai_uas/hapus/"+id,id)
			return true;
		}else{
			return false;
		}
...
<div id="dialog-form">
	...
	<form id="Form" method="GET" action="<?=base_url()?>index.php/data_nilai_uas/viewDetail" charset='utf-8'>
	<fieldset>
...
<div id="Dialog" title="Edit Nilai UAS">
 <form id="formEdit" method="POST" action="<?=base_url()?>index.php/data_nilai_uas/edit" charset="utf-8">
 Ubah Nilai Berikut 
