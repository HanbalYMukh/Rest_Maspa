...
<div id="dialog-form">
	...
	<form id="Form" method="GET" action="<?=base_url()?>index.php/data_nilai_tugas/viewSpesifik" charset='utf-8'>
	<fieldset>
...
<?php echo anchor('data_nilai_tugas/addData/'.$kelas, '<button class="add">Tambah data</button>
'); ?>
