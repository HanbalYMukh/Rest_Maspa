...
<div id="dialog-form">
	...
	<form id="Form" method="GET" action="<?=base_url()?>index.php/data_nilai_praktik/viewSpesifik" charset='utf-8'>
	<fieldset>
...
<button class="add"><?php echo anchor('data_nilai_praktik/addData/'.$kelas, 'Tambah data'); ?></button>
<div id="header_data" align="center">
		...
		<tr>
		  <td align="center" colspan="2"> <span class="seratus">Rekor 100 Nilai praktik Terbaik kelas <? echo "".$nama_kelas->no_ruang; ?></span><span class="datakelas"> kelas <? echo "".$nama_kelas->no_ruang; ?> </span> </td>
		</tr>
		</table>
