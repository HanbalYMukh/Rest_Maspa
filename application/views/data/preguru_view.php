...
<!-- grid -->
<div id="data_tabel">
<table width="95%" border="0" cellpadding="1" cellspacing="1" table class="no-style full" align="center">
...
<table width="95%" border="0" cellpadding="1" cellspacing="1" class="datatable" align="center">
    <thead>
