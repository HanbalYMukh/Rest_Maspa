...
function tanya(id){
		if(confirm('Hapus Data Terpilih?')){
			load_no_loading("<?=base_url()?>index.php/data_nilai_tugas/hapus/"+id,id)
			return true;
		}else{
			return false;
		}
...
function ask(jenis,id){
		if(confirm('Hapus Data Terpilih?')){
			load_onfly_loading("<?=base_url()?>index.php/data_nilai_tugas/hapusOnfly/"+jenis+"/"+id,id,jenis)
			return true;
		}else{
			return false;
		}
...
<div id="dialog-form">
	...
	<form id="Form" method="GET" action="<?=base_url()?>index.php/data_nilai_tugas/viewDetail" charset='utf-8'>
	<fieldset>
...
<div id="Dialog" title="Edit Nilai tugas">
 <form id="formEdit" method="POST" action="<?=base_url()?>index.php/data_nilai_tugas/edit" charset="utf-8">
 Ubah Nilai Berikut 
